...
public enum Stage {
    ...
    SELECTED_EMPLOYEE_NAME_FOR_DELETING_ROLE_USER(),

    ENTER_EMPLOYEE_NAME_ROLE_ADMIN(0),
    ENTER_EMPLOYEE_BIRTHDATE_ROLE_ADMIN(1),
    ENTER_EMPLOYEE_PHONE_NUMBER_ROLE_ADMIN(2),
    ENTER_EMPLOYEE_ADDITIONAL_PHONE_NUMBER_ROLE_ADMIN(),
    ENTER_EMPLOYEE_NATIONALITY(3),
    SELECT_EDUCATION_TYPE(4),
    ENTER_EDUCATION_NAME(5),
    ENTER_EMPLOYEE_EDUCATION_FIELD(6),
    ENTER_EMPLOYEE_EDUCATION_PERIOD(7),
    ENTER_SKILLS,
    SELECT_FILE_TYPE,
    SHARE_ATTACHMENT;
